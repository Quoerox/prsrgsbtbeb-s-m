  ...
  require("moment-duration-format");
    ...
    var kurulus = (Date.now() - member.user.createdTimestamp);
      ...
      if (kurulus > 604800000) {
        ...
        if(taglı === '1'){
          kanal1.send(`  ${tac} **${member.guild.name}** P A R L E U S sunucumuza hoşgeldin ${member}! 
    ...
    ${ates} Kayıt olmak için solda bulunan **⭒Confirmed ¹**/**⭒Confirmed²** odalarına giriş yapıp ses teyit vermelisin.
